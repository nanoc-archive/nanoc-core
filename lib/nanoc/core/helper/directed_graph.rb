...
module Nanoc
  ...
  class DirectedGraph
    ...
    #
    # @return [Enumerable] Direct predecessors of the given vertex
    ...
    #
    # @return [Enumerable] Direct successors of the given vertex
    def direct_successors_of(from)
      @from_graph.fetch(from, [])
    end
    ...
    # @param to The vertex of which the predecessors should be calculated
    #
    # @return [Enumerable] Predecessors of the given vertex
    ...
    # @param from The vertex of which the successors should be calculated
    #
    # @return [Enumerable] Successors of the given vertex
    ...
    # Returns a collection of tuples representing the edges. The result of this
    # method may take a while to compute and should be cached if possible.
    #
    # @return [Enumerable] The collection of all edges in this graph.
    def edges
      result = []
    ...
    #
    # @return [Enumerable] The collection of all root vertices in this graph.
    def roots
      @roots
    end
